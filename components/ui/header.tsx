...
export default function Header() {
  return (
    <header className="fixed top-0 w-full z-30 bg-white-1200 text-white shadow-md">
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden md:flex md:grow">
            ...
            <ul className="flex-grow flex justify-end items-center space-x-4">
              <li>
                <Link href="/" className="font-medium text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out">Home</Link>
              </li>
              <li>
                <Link href="/about" className="font-medium text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out">About Us</Link>
              </li>
              <li>
                <Link href="/activities" className="font-medium text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out">Activities</Link>
              </li>
              <li>
