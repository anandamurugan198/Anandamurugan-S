        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              ...
              <div className="text-gray-400">client choice, we planned to place a enquiry form there</div>
            </div>
            ...
            <div className="md:col-span-4 lg:col-span-5">
              ...
              <div className="text-sm">
                <h3 className="text-gray-200 text-xl mb-2">Contact</h3>
                <ul>
                  <li className="mb-2 text-xl">123 Pillayar kovil street, Kovilambakam, Chennai - 42</li>
                  <li className="mb-2 text-xl">Phone: +91 9876543210</li>
                  <li className="mb-2 text-xl">Email: contact@example.com</li>
                </ul>
              </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy; crapenterprises.com. All rights reserved.</div>
